...
class BasicMessage implements RawMessage, GetInstance {
    ...
    public String toString() {
        return String.format("BasicMessage<%s>", new Object[]{getType()});
    }

    public int hashCode() {
        int prime = 31;
        int result = 1;
        result = 31 * result + (this.messageContext == null ? 0 : this.messageContext.hashCode());
        result = 31 * result + (this.messageFields == null ? 0 : this.messageFields.hashCode());
        return result;
    }
