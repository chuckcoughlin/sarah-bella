 ...
 * the License.
 *
 * Modified 2017 Chuck Coughlin to update the use of Notifications
 */
...
public class NodeMainExecutorService extends Service implements NodeMainExecutor {
    private static final String ROS_CHANNEL_NAME = "ros_channel";    // Can't use channels until SDK 26
    private static final int NOTIFICATION_ID = ROS_CHANNEL_NAME.hashCode();
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent.getAction().equals(ACTION_START)) {
            ...
            Notification notification = new Notification.Builder(this)
                    .setContentTitle("ROS Main Executor Service")
                    .setContentText("ROS Service")
