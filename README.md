...
2) android: An Android tablet provides the robot user interface, communicating via wi-fi and ROS messaging. The Android application
 ...
 As of November, 2018 this project is considered essentially complete. Documentation may describe features contemplated but never implemented. The following major features can be considered "done":
