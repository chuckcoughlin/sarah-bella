...
class Parker:
	...
	def park(self):
		...
		self.moveToTarget(self.pillarSeparation/2.,-0.5*ROBOT_WIDTH,False)
		self.report("Park: straighten")
		self.moveToTarget(3*self.pillarSeparation/8.,-0.5*ROBOT_WIDTH,True)
